...
<head>
    ...
    <title>DEE MART - STAFF LOGIN</title>
                    ...
                    <div class="login-popup" style="margin: 0 auto; max-width: 500px; padding: 30px;">
                        <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                            <ul class="nav nav-tabs text-uppercase" role="tablist">
                                <li class="nav-item">
                                    <a href="#sign-in" class="nav-link active">Staff Login</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="sign-in">
                                    <form id="loginForm" method="post">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <span onclick="togglePassword('password', 'eyeIcon2')" style="position:absolute; right:15px; top:50%; transform:translateY(-50%); cursor:pointer; color:#8aaad4;">
								...
								icon.innerHTML = isHidden
                                    ...
                                    <p class="text-center mt-4">New here? <a href="staff-index.php" class="text-primary">Create an Account</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
