                        ...
                        <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="sign-up">
                                    ...
                                    <p class="text-muted text-center mb-4">Please enter the OTP (one time password) to verify your account. A code has been sent to <span class="text-dark text-4"><?php echo $customer_email;?></span></p>
                                    ...
                                    <form id="otp-screen" method="post">
                                        ...
                                        if(isset($_REQUEST["verify"])){
                                            ...
                                            if($dbotp!=$newotp){
                                                ...
                                                $sql="UPDATE customertable SET `status`='Verified' WHERE customer_email='$customer_email'";
                                                $result=mysqli_query($conn, $sql);
                                                if($result){
                                    ...
                                    <p class="text-center mt-4">Not received your code? <a href="user-resendotp.php" class="text-primary">Resend code</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
