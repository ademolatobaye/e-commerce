                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="delete-blog.php?id=<?php echo $row['id']?>" onclick="return confirm('Are you sure to delete this blog?')">Delete Blog</a>

                                                            <a class="dropdown-item" href=".php?id=<?php echo $row['id']?>">View Blog</a>

                                                            <a class="dropdown-item" href=".php?id=<?php echo $row['id']?>"> Edit Blog</a>
                                                        </div>
                                                    </div>
                                                        </td>
                                                    </tr>
