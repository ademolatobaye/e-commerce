...
<head>
    ...
    <!-- TITLE -->
    <title>THEADEMOLA – Edit Product</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    //  END
                                        ...
                                        $sql="UPDATE product_table SET productname='$productname', costprice='$costprice', sellingprice='$sellingprice', quantity='$quantity', productimage='$productimage', profit='$profit', category='$category', `description`='$description', staff='$staff' WHERE id='$_REQUEST[id]'";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control" name="costprice" value="<?php echo $product['costprice']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control" name="sellingprice" value="<?php echo $product['sellingprice']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 mb-4">
                                                <textarea class="content" name="description" value="<?php echo $product['description']?>"></textarea>
                                            </div>
                                        </div>
                                        <!--End Row-->
