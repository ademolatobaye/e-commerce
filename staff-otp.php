...
<head>
    ...
    <title>DEE MART - STAFF OTP</title>
                        ...
                        <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="sign-up">
                                    ...
                                    <form id="otp-screen" method="post">
                                        ...
                                        if(isset($_REQUEST["verify"])){
                                            if (isset($_SESSION['otp_time']) && (time() - $_SESSION['otp_time']) > 300) {
                                                echo "<script>alert('OTP has expired after 5 minutes! Please request a new one.'); window.location.href='staff-otp.php';</script>";
                                                exit();
                                            }
                                            $n1=$_REQUEST["n1"];
                                            $n2=$_REQUEST["n2"];
                                            ...
                                            if($dbotp!=$newotp){
                                                ...
                                                if($result){
                                                    ...
                                                    window.location.href='staff-register.php'</script>";
                                                }
                                            }
                                        }
                                        ?>
                                        ...
                                        if (remaining > 0) {
                                            const interval = setInterval(() => {
                                                ...
                                                if (remaining <= 0) {
                                                    ...
                                                    window.location.href = 'staff-otp.php';
                                                } else {
                                    ...
                                    <p class="text-center mt-4">Not received your code? <a href="staff-resendotp.php" class="text-primary">Resend code</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
